    ...
    <div className="mb-20" id="contact" >
      <div className="md:w-10/12 w-11/12 mx-auto ">
        ...
        <div className="md:w-8/12 w-full mx-auto">
            ...
            <p className='text-xl text-neutral-200 mb-5'>Our Email: <span className='italic text-sm text-neutral-400'>inquiry@bharatrobotix.com</span></p>
          <motion.form ref={form} onSubmit={sendEmail} variants={container} viewport={{ once: true, amount: 0.5 }} initial="hidden" whileInView="show"  action="" className="border-2 border-neutral-700 rounded-xl p-8">
            ...
            <motion.button variants={item} className="bg-yellow-700 hover:bg-blue-600 transition-all ease-in duration-200 px-32 py-3 mt-10 rounded-full">Submit</motion.button>
          </motion.form>
        </div>
      </div>
    </div>
