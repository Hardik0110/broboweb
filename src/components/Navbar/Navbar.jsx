...
function Navbar() {
  ...
  return (
    ...
    <div className={` ${isTopOfPage ? "": "bg-[#ea6d30]"} md:px-16 sm:px-8 z-40 w-full fixed top-0 pt-5 pb-5 transition duration-300`}>
        <nav className='flex items-center justify-between'>
            ...
            <div className={`nav-list lg:block absolute right-10 lg:relative lg:top-0 transition-all duration-100 ease-in ${isOpen ? "top-[50px]":"top-[-100px]"}`}>
                <ul className={`flex text-gray-300  ${isOpen? "flex-col space-y-5": "flex-row space-x-6"}`}>
                    ...
                    <li className='hover:text-[#ec008c] transition-all duration-200 ease-in cursor-pointer'><a href="#projects">Robots</a></li>
                    ...
                    <li className='hover:text-[#ec008c] transition-all duration-200 ease-in cursor-pointer'><a href="#contact">Contact Us</a></li>
                </ul>
            </div>
