        ...
        <div className='w-10/12 mx-auto'>
            <div className='grid sm:grid-cols-1 md:grid-cols-2 gap-10'>
                <motion.div initial={{opacity: 0, x: -150 }}
                    ...
                    <p className='text-sm mb-8 mt-4 w-10/12 mx-auto text-neutral-300'>"Clients Testimonials  "</p>
                    <h1 className='mt-2 text-xl blue-text-gradient'>"anything more"</h1>
                    <p className='mb-6 mt-1 text-sm italic text-neutral-400'>Robot developers</p>
                ...
                <motion.div initial={{opacity: 0, x: 150 }}
                    ...
                    transition={{ duration: 0.6 }}
                    className='border-2 border-neutral-400 rounded-xl p-2 relative text-center'>
                    <p className='text-sm mb-8 mt-4 w-10/12 mx-auto text-neutral-300'>"client number2 testimonials"</p>
                    <h1 className='mt-2 text-xl blue-text-gradient'>anyname would be fine</h1>
                    <p className='mb-6 mt-1 text-sm italic text-neutral-400'>client description</p>
                    <div className='w-10 h-10 absolute top-[100%] left-[50%] translate-x-[-50%] translate-y-[-50%] '>
                ...
                <motion.div initial={{opacity: 0, x: -150 }}
                    ...
                    transition={{ duration: 0.6 }}  
                    className='border-2  border-neutral-400 rounded-xl p-2 relative text-center'>
                    <p className='text-sm mb-8 mt-4 w-10/12 mx-auto text-neutral-300'>"client number3 testimonial."</p>
                    <h1 className='mt-2 text-xl blue-text-gradient'>anyname willdo </h1>
                    <p className='mb-6 mt-1 text-sm italic text-neutral-400'>client job title</p>
                    <div className='w-10 h-10 absolute top-[100%] left-[50%] translate-x-[-50%] translate-y-[-50%] '>
